<?php
/**
 * GitHub Webhook Deploy Script - DaytonaSpin UK
 * Pulls from the shared repo, then copies daytonaspin-uk.com files
...
// Copy daytonaspin-uk.com files to THIS directory
$src = $repo_path . '/daytonaspin-uk.com';
$dst = __DIR__;
$file_count = 0;
...
$log_entry = "[$timestamp] DaytonaSpin UK deploy\n";
