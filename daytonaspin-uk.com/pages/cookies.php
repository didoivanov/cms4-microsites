<?php
/**
 * Cookie Policy - DaytonaSpin UK
 */
$page_title = 'Cookie Policy - ' . SITE_NAME_SHORT;
$page_description = 'Cookie policy for ' . DOMAIN . '. Learn what cookies we use and how to manage them.';
...
<main>
  <section class="content-section legal-page">
    <div class="container container--narrow">
      ...
      <p><?php echo DOMAIN; ?> is a lightweight affiliate review site. We do not use cookies for advertising, personalisation, or tracking across other websites. The cookies on this site fall into two categories:</p>
      ...
      <h2>Contact</h2>
      <p>If you have questions about our use of cookies, please visit our <a href="/support">Support</a> page.</p>
    </div>
  </section>
</main>
