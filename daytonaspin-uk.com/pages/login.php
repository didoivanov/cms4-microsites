...
<main>
    ...
    <div class="container container--narrow">
      ...
      <div class="two-col" style="align-items:center;gap:var(--space-8);margin-bottom:var(--space-6)">
        <div>
          ...
          <h3>Mobile Login</h3>
          <p>On your phone or tablet, open the <?php echo SITE_NAME; ?> website in your mobile browser. Tap the "Log In" button, enter your email and password, and tap "Log In." The mobile version offers the same features as the desktop site.</p>
        </div>
        <div style="text-align:center;flex-shrink:0">
          <img src="/assets/img/daytonaspin-login-screen.png" alt="<?php echo SITE_NAME; ?> Casino login form with email and password fields" style="max-width:260px;width:100%;border-radius:24px;box-shadow:0 8px 32px rgba(0,0,0,.3)">
        </div>
      </div>
      ...
      <p>If none of the above resolves the issue, reach out to <a href="/support">customer support</a> via live chat or email at support@daytonaspin.com for assistance.</p>
    </div>
  </section>
  ...
  <section class="content-section" id="register">
    <div class="container container--narrow">
      ...
      <div class="two-col" style="align-items:center;gap:var(--space-8);margin-bottom:var(--space-6)">
        <div>
          <p>If you do not have a <?php echo SITE_NAME; ?> account yet, registration is quick and takes about a minute. Enter your email, create a password, and confirm you are over 18. The first deposit bonus is shown right on the sign-up screen so you know what you are getting from the start.</p>
        </div>
        <div style="text-align:center;flex-shrink:0">
          <img src="/assets/img/daytonaspin-signup-screen.png" alt="<?php echo SITE_NAME; ?> Casino sign up form showing first deposit bonus and registration fields" style="max-width:260px;width:100%;border-radius:24px;box-shadow:0 8px 32px rgba(0,0,0,.3)">
        </div>
      </div>
      ...
      <ol class="steps-list">
        ...
        <li>
          <div>
            <strong>Fill in your personal details.</strong> You will need to provide your full name, date of birth, phone number, and address. This information is needed for account verification when you request your first withdrawal.
          </div>
        </li>
        <li>
          <div>
            <strong>Complete registration.</strong> Finalise your account and make your first deposit to claim the welcome bonus. The minimum qualifying deposit is &pound;45.
          </div>
        </li>
      </ol>
  ...
  <section class="content-section content-section--alt" id="recovery">
    <div class="container container--narrow">
      ...
      <p>Account locks can occur for security reasons, such as multiple failed login attempts or suspicious activity. Contact customer support through live chat or email at support@daytonaspin.com to have your account reviewed.</p>
    </div>
  </section>
  ...
  <section class="content-section" id="login-faq">
    <div class="container container--narrow">
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Account locks can occur after multiple failed login attempts or due to suspicious activity. Contact customer support through live chat or email at support@daytonaspin.com to have your account reviewed and unlocked.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Registration requires an email address, a password, full name, date of birth, phone number, and address. This information is used for identity verification and regulatory compliance.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>No dedicated app is available, but the website is fully optimised for mobile devices. Simply open <?php echo SITE_NAME; ?> in your mobile browser and log in as normal. All games and features are accessible on mobile.</p>
        </div>
      </details>
    </div>
  </section>
