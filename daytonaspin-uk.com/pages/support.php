<?php
/**
 * Support Page - DaytonaSpin UK
 */
$page_title = SITE_NAME . ' Customer Support - Live Chat, Email & Help Centre';
$page_description = 'Reach ' . SITE_NAME . ' Casino customer support via 24/7 live chat or email at support@daytonaspin.com. Get help with deposits, withdrawals, bonuses, account issues, and technical questions.';
...
<main>
  ...
  <section class="content-section" id="contact">
    <div class="container">
      ...
      <p><?php echo SITE_NAME; ?> offers two support channels so you can always get help when you need it. Whether you have a quick question about a promotion or need help resolving a payment issue, the team is available around the clock.</p>

      <div class="info-grid">
        <div class="info-card">
          <div class="info-card__icon">&#128172;</div>
          <h4>Live Chat</h4>
          <p>The fastest way to get help. Click the chat icon on any page of the website to start a conversation with a support agent. You will need to provide your email, name, and phone number to begin. Available 24 hours a day, 7 days a week. Agents typically respond within a few minutes.</p>
        </div>
        <div class="info-card">
          <div class="info-card__icon">&#9993;</div>
          <h4>Email Support</h4>
          <p>For detailed questions or document submissions, email is the best option. Send your enquiry to <strong>support@daytonaspin.com</strong> and expect a response within 24 hours. Be sure to include your account details and a clear description of the issue.</p>
        </div>
      </div>
  ...
  <section class="content-section" id="tips">
    <div class="container container--narrow">
      ...
      <ol class="steps-list">
        ...
        <li>
          <div>
            <strong>Use the right channel.</strong> For urgent issues (locked account, failed deposit), live chat is your best bet. For document submissions or complex cases requiring investigation, email at support@daytonaspin.com gives the team more room to work.
          </div>
        </li>
        <li>
          <div>
  ...
  <section class="content-section content-section--alt" id="responsible">
    <div class="container container--narrow">
      ...
      <p><?php echo SITE_NAME; ?> takes responsible gambling seriously. If you feel that your gambling habits are becoming a problem, the support team can help you arrange a self-exclusion from the platform.</p>
      <p>Self-exclusion options range from 6 months to 5 years, or permanent closure. Once activated, self-exclusion cannot be reversed until the set period expires. During the self-exclusion period, you will not be able to log in or make any withdrawals. Contact support via live chat or email at support@daytonaspin.com to request self-exclusion.</p>
  ...
  <section class="content-section" id="support-faq">
    <div class="container container--narrow">
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Live chat agents typically respond within a few minutes. During peak hours, wait times may be slightly longer.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>You can reach <?php echo SITE_NAME; ?> support by email at <strong>support@daytonaspin.com</strong>. Include your username or registered email, a description of the issue, and any relevant screenshots. Expect a response within 24 hours.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>If you are not satisfied with the initial response, ask for your case to be escalated to a senior agent. For unresolved disputes, you may also contact the Anjouan Gaming Authority directly through the regulator's seal on the <?php echo SITE_NAME; ?> website.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Yes. Contact support via live chat or email to arrange self-exclusion for a period between 6 months and 5 years, or permanently. During self-exclusion, you cannot log in or make withdrawals.</p>
        </div>
      </details>
    </div>
  </section>
