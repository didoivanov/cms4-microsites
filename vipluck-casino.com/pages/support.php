 ...
 * Support Page
 */
$page_title = SITE_NAME . ' Customer Support - Live Chat, Email, Telegram & Help Center';
$page_description = 'Reach ' . SITE_NAME . ' Casino customer support via 24/7 live chat, email at support@vipluck.com, or Telegram. Get help with deposits, withdrawals, bonuses, account issues, and technical questions.';
...
<main>
  ...
  <section class="content-section" id="contact">
    <div class="container">
      ...
      <p><?php echo SITE_NAME; ?> offers three support channels to make sure you can always get help when you need it. Whether you have a quick question about a promotion, need help resolving a payment issue, or prefer to communicate through a messaging app, the team is ready to assist.</p>
      ...
      <div class="info-grid">
        ...
        <div class="info-card">
          <div class="info-card__icon">&#9993;</div>
          <h4>Email Support</h4>
          <p>For detailed questions or document submissions, email is the best option. Send your inquiry to <strong>support@vipluck.com</strong> and expect a response within 24 hours. Be sure to include your account details and a clear description of the issue.</p>
        </div>
        <div class="info-card">
          <div class="info-card__icon">&#9992;</div>
          <h4>Telegram</h4>
          <p><?php echo SITE_NAME; ?> maintains an official Telegram channel for support and announcements. You can reach the team there for quick questions, updates on promotions, and general assistance. Look for the Telegram link on the casino website.</p>
        </div>
      </div>
      ...
      <table class="data-table" style="margin-top: var(--space-8);">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>24/7</td>
            <td>Varies</td>
            <td>Quick questions, promotions, announcements</td>
          </tr>
          <tr>
            <td>Phone</td>
            <td>Not available</td>
    ...
    <div class="container">
      ...
      <div class="info-grid">
        <div class="info-card">
          ...
          <p>Help with creating an account, updating personal information, resetting passwords, recovering usernames, and resolving login issues. If your account is locked or restricted, support can review your status.</p>
        </div>
        <div class="info-card">
        ...
        <div class="info-card">
          ...
          <p>Questions about withdrawal processing times, pending requests, declined payouts, and limit adjustments. Note that <?php echo SITE_NAME; ?> does not process withdrawals on weekends. For detailed withdrawal information, visit the <a href="/withdrawal">Withdrawal page</a>.</p>
        </div>
        <div class="info-card">
  ...
  <section class="content-section" id="languages">
    <div class="container container--narrow">
      ...
      <p>The <?php echo SITE_NAME; ?> website is available in 13 languages to serve players across multiple regions:</p>
      <div class="info-grid">
        <div class="info-card">
      ...
      <p>Support agents can typically assist in English and may be able to help in other listed languages depending on availability.</p>
    </div>
  </section>
  ...
  <section class="content-section content-section--alt" id="tips">
    <div class="container container--narrow">
      ...
      <ol class="steps-list">
        ...
        <li>
          <div>
            <strong>Use the right channel.</strong> For urgent issues (locked account, failed deposit), live chat is your best bet. For document submissions or complex cases requiring investigation, email at support@vipluck.com gives the team more room to work. For quick questions or promo updates, try the Telegram channel.
          </div>
        </li>
        <li>
          <div>
  ...
  <section class="content-section" id="responsible">
    <div class="container container--narrow">
      ...
      <p>Self-exclusion options range from temporary breaks to permanent account closure. Once activated, self-exclusion cannot be reversed until the set period expires. Contact support via live chat, email at support@vipluck.com, or Telegram to discuss available options.</p>
    ...
    <div class="container container--narrow">
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>The website is available in 13 languages: English, German, Norwegian, French, Italian, Spanish, Portuguese, Greek, Arabic, Polish, Hungarian, Finnish, and Czech. Support agents can typically assist in English and may be able to help in other listed languages depending on availability.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>You can reach <?php echo SITE_NAME; ?> support by email at <strong>support@vipluck.com</strong>. Include your username or registered email, a description of the issue, and any relevant screenshots or transaction references. Expect a response within 24 hours.</p>
        </div>
      </details>

      <details class="faq-item">
        <summary>Can I reach support through Telegram?</summary>
        <div class="faq-answer">
          <p>Yes. <?php echo SITE_NAME; ?> has an official Telegram channel where you can get support, see promotions, and receive updates. Look for the Telegram link on the casino website for the official channel.</p>
        </div>
      </details>
