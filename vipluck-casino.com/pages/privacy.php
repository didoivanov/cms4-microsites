<?php
/**
 * Privacy Policy - VipLuck
 */
$page_title = 'Privacy Policy - ' . SITE_NAME . ' Casino';
$page_description = 'Privacy policy for ' . SITE_DOMAIN . '. Learn how we handle your data as an independent affiliate site reviewing ' . SITE_NAME . ' Casino.';
  ...
  <section class="content-section legal-page">
    <div class="container container--narrow">
      ...
      <ul>
        ...
        <li><strong>Cookies and similar technologies</strong> - small text files stored in your browser for analytics and basic site functionality. See our <a href="/cookies">Cookie Policy</a> for full details.</li>
      ...
      <ul>
        ...
        <li><strong>Cloudflare</strong> - for content delivery, DNS management, and security</li>
      ...
      <ul>
        ...
        <li>Withdraw consent at any time (for example, by disabling cookies in your browser)</li>
        <li>Lodge a complaint with your local data protection authority</li>
      </ul>
      <p>Since we do not collect personal data through this site, these rights are unlikely to be relevant in practice. If you have any concerns, please contact us.</p>
      ...
      <p>Some third-party services we use (such as Google Analytics and Cloudflare) may process data outside the European Economic Area. Where this occurs, appropriate safeguards are in place in accordance with GDPR requirements.</p>

      <h2>Children</h2>
      <p>This website is intended for adults aged 18 and over. We do not knowingly collect data from anyone under 18.</p>

      <h2>Contact</h2>
      <p>If you have questions about this privacy policy, you can reach us at <a href="mailto:info@<?php echo SITE_DOMAIN; ?>">info@<?php echo SITE_DOMAIN; ?></a> or visit our <a href="/support">Support</a> page.</p>
