...
if (preg_match('/^[\w.-]+\.(html|txt|xml)$/', $_requested)) {
    $_candidates = [
        __DIR__ . '/' . $_requested,
        '/home/cms4netp/simplemicrosites/westace.site/' . $_requested,
    ];
...
if (file_exists(__DIR__ . '/config.php')) {
    ...
    require_once '/home/cms4netp/simplemicrosites/westace.site/config.php';
}

// Define repo source fallback path
define('REPO_SRC', '/home/cms4netp/simplemicrosites/westace.site');
