...
<main>
  ...
  <section class="content-section" id="overview">
    <div class="container">
      ...
      <p>Cashing out at <?php echo SITE_NAME; ?> is simple and fee-free. We process all withdrawal requests within 24 to 72 hours depending on the payment method. Funds are returned to the same method you used for your deposit whenever possible. You must complete KYC verification before your first withdrawal.</p>

      <div class="info-grid">
        <div class="info-card">
          <div class="info-card__icon">&#128176;</div>
          <h4>Min Withdrawal</h4>
          <p>&euro;10 across all payment methods. Amounts below this threshold cannot be processed.</p>
        </div>
        <div class="info-card">
          <div class="info-card__icon">&#128200;</div>
        ...
        <div class="info-card">
          ...
          <p>&euro;500 per day, &euro;7,000 per month. VIP members may qualify for higher limits.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="content-section content-section--alt" id="how-to">
    <div class="container">
      ...
      <ol class="steps-list">
        ...
        <li>
          <div>
            <strong>Select your payment method and amount.</strong> Choose from the available options and enter the amount you wish to withdraw. The minimum is &euro;10 across all methods. Daily limit is &euro;500, monthly limit is &euro;7,000.
          </div>
        </li>
        <li>
          <div>
  ...
  <section class="content-section content-section--alt" id="withdrawal-faq">
    <div class="container container--narrow">
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>The minimum withdrawal amount is &euro;10 for all payment methods.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Standard limits are &euro;500 per day and &euro;7,000 per month. Per-transaction limits depend on the method: Visa and Mastercard cap at &euro;3,000 per transaction, while Skrill, bank transfers, and all cryptocurrencies allow up to &euro;5,000. VIP players may qualify for higher limits.</p>
        </div>
      </details>
