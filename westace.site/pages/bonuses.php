<?php
/**
 * Bonuses Page - WestAce
 */
$page_title = SITE_NAME . ' Bonuses - Welcome Bonus, Free Spins, Cashback & VIP Rewards';
$page_description = 'All ' . SITE_NAME . ' Casino bonuses in one place. Welcome package up to EUR 2,000 + 150 free spins across 3 deposits, crypto welcome, weekly reloads, daily cashback, live cashback, VIP programme and more.';
...
<main>
    ...
    <div class="container">
      ...
      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">1st Deposit: 100% up to &euro;1,000 + 50 Free Spins</div>
          <span class="bonus-card__tag">Casino</span>
        </div>
        <p>Make your first deposit of at least &euro;20 and receive a 100% match up to &euro;1,000. On top of that, 50 free spins are credited on a featured slot. The wagering requirement is 35x on the bonus + deposit amount. Free spins winnings carry a separate 40x wagering requirement.</p>
      ...
      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">2nd Deposit: 100% up to &euro;500 + 50 Free Spins</div>
          <span class="bonus-card__tag">Casino</span>
        </div>
        <p>Your second deposit qualifies for a 100% match up to &euro;500, plus another 50 free spins. The same wagering requirements apply as the first deposit bonus.</p>
        <div class="bonus-card__details">
          <div>
            <div class="bonus-detail__label">Min. Deposit</div>
            <div class="bonus-detail__value">&euro;20</div>
      ...
      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">3rd Deposit: 100% up to &euro;500 + 50 Free Spins</div>
          <span class="bonus-card__tag">Casino</span>
        </div>
        <p>The third deposit earns a 100% match up to &euro;500 and 50 free spins. This brings the total welcome package to &euro;2,000 in bonus funds and 150 free spins across your first three deposits.</p>
        <div class="bonus-card__details">
          <div>
            <div class="bonus-detail__label">Min. Deposit</div>
            <div class="bonus-detail__value">&euro;20</div>
  ...
  <section class="content-section" id="weekly-reload">
    <div class="container">
      ...
      <div class="bonus-card">
        ...
        <p>Every week from Monday to Thursday, make a deposit of at least &euro;20 and receive 70 free spins on a featured slot chosen by the casino. Winnings from the free spins carry a 40x wagering requirement and must be used within 10 days.</p>
        <div class="bonus-card__details">
          <div>
            <div class="bonus-detail__label">Min. Deposit</div>
            <div class="bonus-detail__value">&euro;20</div>
  ...
  <section class="content-section content-section--alt" id="weekend-reload">
    <div class="container">
      ...
      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">Weekend: 50% up to &euro;500 + 70 Free Spins</div>
          <span class="bonus-card__tag">Weekend</span>
        </div>
        <p>Kick off the weekend with a 50% bonus match up to &euro;500. If your deposit is &euro;50 or more, you also receive 70 free spins. Deposits below &euro;50 still qualify for the 50% match, but the free spins are not included. Wagering requirement is 35x on the bonus amount.</p>
        <div class="bonus-card__details">
          <div>
            <div class="bonus-detail__label">Min. Deposit</div>
            <div class="bonus-detail__value">&euro;20</div>
  ...
  <section class="content-section" id="live-cashback">
    <div class="container">
      ...
      <div class="bonus-card">
        ...
        <p>All players can claim up to 25% cashback on net losses from live casino games, with a maximum payout of &euro;300. The wagering requirement is just 1x. However, this cashback must be requested manually via live chat or email every Monday between 06:00 and 23:59 UTC. If you miss the claim window, the cashback for that week is forfeited.</p>
        <div class="bonus-card__details">
          <div>
  ...
  <section class="content-section" id="no-deposit">
    <div class="container container--narrow">
      ...
      <p>At present, <?php echo SITE_NAME; ?> does not offer a no-deposit bonus. The welcome package requires a minimum first deposit of &euro;20 to activate. Keep an eye on the Promotions section and check back regularly, as we frequently rotate our offers and may introduce no-deposit deals in the future.</p>
    </div>
  </section>
  ...
  <section class="content-section content-section--alt" id="bonus-faq">
    <div class="container container--narrow">
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>The full welcome package is worth up to &euro;2,000 in bonus funds plus 150 free spins across three deposits. Each deposit receives a 100% match: up to &euro;1,000 on the first, and up to &euro;500 on each of the second and third.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Yes. Crypto depositors can claim a 200% match up to 3,000 USDT as a welcome bonus, plus weekly and weekend crypto reload offers. These are separate from the standard EUR bonuses and carry their own wagering requirements.</p>
        </div>
      </details>
    </div>
  </section>
