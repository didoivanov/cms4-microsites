<?php
/**
 * Cookie Policy - WestAce (UK English)
 */
$page_title = 'WestAce Cookie Policy - How We Use Cookies';
$page_description = 'Cookie policy for ' . DOMAIN . '. Learn what cookies we use, how to manage them, and your rights under UK GDPR and PECR.';
...
<main>
  <section class="content-section legal-page">
    <div class="container container--narrow">
      ...
      <h2>Your Rights</h2>
      <p>Under UK GDPR, you have the right to request access to, correction of, or deletion of any personal data we hold. Since our cookies do not collect personally identifiable information, these rights are unlikely to be relevant in practice. If you have concerns, you can contact the Information Commissioner's Office (ICO) at <a href="https://www.ico.org.uk" target="_blank" rel="noopener noreferrer">ico.org.uk</a> or call their helpline on 0303 123 1113.</p>
