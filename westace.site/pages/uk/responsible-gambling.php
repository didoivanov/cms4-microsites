<?php
/**
 * Responsible Gambling - WestAce (UK English)
 */
$page_title = 'WestAce Responsible Gambling - Help & Self-Exclusion Tools';
$page_description = 'Responsible gambling information and resources for UK players. Find help through GamCare, BeGambleAware, GamStop, and the National Gambling Helpline on 0808 8020 133.';
...
<main>
  <section class="content-section legal-page">
    <div class="container container--narrow">
      ...
      <h2>Our Position</h2>
      <p><?php echo DOMAIN; ?> is an independent affiliate review site. We do not operate a casino, accept bets, or handle customer funds. However, because we link to real-money gambling platforms, we take responsible gambling seriously and want to make sure you have the information and resources you need.</p>
      ...
      <p>Gambling is strictly for people aged 18 and over. It is a criminal offence under the Gambling Act 2005 for anyone under 18 to gamble, and for any operator to knowingly allow it. If you share a device with someone under 18, consider using parental controls or filtering software such as:</p>
      <ul>
      ...
      <div class="info-grid">
        <div class="info-card">
          <h4>GamCare</h4>
          <p>Free information, support, and counselling for anyone affected by gambling. Runs the National Gambling Helpline, available 24/7.</p>
          <p><a href="https://www.gamcare.org.uk" target="_blank" rel="noopener noreferrer">www.gamcare.org.uk</a><br>Phone: 0808 8020 133</p>
        </div>
        <div class="info-card">
          <h4>BeGambleAware</h4>
          <p>Provides information and practical advice on gambling harm, including a directory of treatment services across the UK.</p>
          <p><a href="https://www.begambleaware.org" target="_blank" rel="noopener noreferrer">www.begambleaware.org</a></p>
        </div>
        <div class="info-card">
          <h4>GamStop</h4>
          <p>The UK's free self-exclusion service. Register once to be excluded from all UKGC-licensed online gambling sites for 6 months, 1 year, or 5 years.</p>
          <p><a href="https://www.gamstop.co.uk" target="_blank" rel="noopener noreferrer">www.gamstop.co.uk</a></p>
        </div>
        <div class="info-card">
          <h4>Gambling Commission (UKGC)</h4>
          <p>The UK's regulatory body for gambling. Publishes guidance, handles complaints about licensed operators, and oversees standards across the industry.</p>
          <p><a href="https://www.gamblingcommission.gov.uk" target="_blank" rel="noopener noreferrer">www.gamblingcommission.gov.uk</a></p>
        </div>
      </div>
      ...
      <div class="info-grid">
        ...
        <div class="info-card">
          ...
          <p>A fellowship of men and women who share their experience to help each other recover from a gambling problem. Meetings available throughout the UK.</p>
          <p><a href="https://www.gamblersanonymous.org.uk" target="_blank" rel="noopener noreferrer">www.gamblersanonymous.org.uk</a></p>
        </div>
      </div>

      <h2>National Gambling Helpline</h2>
      <p>If you need to talk to someone right now, call the National Gambling Helpline on <strong>0808 8020 133</strong>. The line is free, confidential, and available 24 hours a day, 7 days a week. It is run by GamCare and staffed by trained advisers who can provide immediate support and referrals.</p>

      <h2>Our Commitment</h2>
      <p>Although we are an affiliate site and not the casino operator, we are committed to promoting responsible gambling. We will never target vulnerable individuals, minors, or people who have self-excluded. If you feel our content is inappropriate or harmful, please contact us at <a href="mailto:info@westace.site">info@westace.site</a> or through our <a href="<?php echo $lang_prefix; ?>/support">Support</a> page.</p>
    </div>
  </section>
</main>
