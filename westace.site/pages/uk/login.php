...
<main>
  ...
  <section class="content-section content-section--alt" id="login-help">
    <div class="container container--narrow">
      ...
      <p>If none of the above resolves the issue, reach out to <a href="<?php echo $lang_prefix; ?>/support">customer support</a> via live chat or email at support@westace.com for assistance.</p>
    </div>
  </section>
  ...
  <section class="content-section" id="register">
    <div class="container container--narrow">
      ...
      <ol class="steps-list">
        ...
        <li>
          <div>
            <strong>Complete registration.</strong> Finalise your account and make your first deposit to claim the welcome bonus. The minimum qualifying deposit is &pound;17.
          </div>
        </li>
      </ol>
  ...
  <section class="content-section content-section--alt" id="recovery">
    <div class="container container--narrow">
      ...
      <p>If you do not receive the email within a few minutes, check your spam or junk folder. If the email still does not arrive, contact <a href="<?php echo $lang_prefix; ?>/support">customer support</a> for manual assistance.</p>
