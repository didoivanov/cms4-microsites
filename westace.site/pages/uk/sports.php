<?php
/**
 * Sports Betting Page - WestAce (UK English)
 */
$page_title = 'WestAce Sports Betting - Football, Horse Racing, Live & Virtual Sports';
...
<main>
  ...
  <section class="content-section" id="overview">
    <div class="container">
      ...
      <div class="two-col" style="align-items:center;gap:var(--space-8);margin-bottom:var(--space-6)">
        <div>
          <p><?php echo SITE_NAME; ?> is more than just a casino. We offer a full sportsbook covering pre-match betting, live in-play markets, virtual sports, and horse racing. Whether you follow the Premier League, the FA Cup, or Grand Slam tennis, you will find competitive odds and a wide range of markets on every major event.</p>
        ...
        <div style="text-align:center;flex-shrink:0">
          <img src="/assets/img/westace-sports-screen.png" alt="<?php echo SITE_NAME; ?> sportsbook showing live Premier League betting odds and football markets" style="max-width:280px;width:100%;border-radius:24px;box-shadow:0 8px 32px rgba(0,0,0,.3)">
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="two-col">
        <div>
          ...
          <ul class="check-list">
            <li>Football -- Premier League, FA Cup, Championship, La Liga, Bundesliga, Serie A, Champions League, World Cup qualifiers, and hundreds of lower leagues</li>
            ...
            <li>Cricket -- IPL, international test matches, T20 World Cup, The Ashes</li>
  ...
  <section class="content-section" id="horse-racing">
    <div class="container container--narrow">
      ...
      <p>Key meetings like Cheltenham, Royal Ascot, the Grand National, the Derby at Epsom, and the Melbourne Cup are covered with a full range of markets. For everyday racing, we offer standard win and place betting on most UK and Irish fixtures.</p>
    </div>
  </section>
  ...
  <section class="content-section content-section--alt" id="sports-faq">
    <div class="container container--narrow">
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Minimum bets vary by sport and market but are typically very low, starting from &pound;0.50 on most events. Check the bet slip for the exact minimum on each market.</p>
        </div>
      </details>
    </div>
  </section>
