<?php
/**
 * Support Page - WestAce (UK English)
 */
    ...
    <div class="container">
      ...
      <div class="info-grid">
        ...
        <div class="info-card">
          ...
          <p>Questions about withdrawal processing times, pending requests, and declined payouts. For detailed withdrawal information, visit the <a href="<?php echo $lang_prefix; ?>/withdrawal">Withdrawal page</a>.</p>
        </div>
        <div class="info-card">
  ...
  <section class="content-section" id="support-faq">
    <div class="container container--narrow">
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Yes. Contact support via live chat or email to arrange self-exclusion for a set period or permanently. You can also register with <a href="https://www.gamstop.co.uk" target="_blank" rel="noopener noreferrer">GamStop</a> for a national self-exclusion scheme covering all licensed online gambling operators in Great Britain. During self-exclusion, you cannot log in or place any bets.</p>
        </div>
      </details>
    </div>
  </section>
