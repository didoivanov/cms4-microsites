<?php
/**
 * Privacy Policy - WestAce
 */
$page_title = 'Privacy Policy - ' . SITE_NAME_SHORT;
$page_description = 'Privacy policy for ' . DOMAIN . '. Learn how we handle your data as an independent affiliate review site.';
...
<main>
  <section class="content-section legal-page">
    <div class="container container--narrow">
      ...
      <h2>Contact</h2>
      <p>If you have questions about this privacy policy, you can reach us at <a href="mailto:info@westace.site">info@westace.site</a> or visit our <a href="/support">Support</a> page.</p>
