<?php
/**
 * Withdrawal Page - WestAce (AU / Australian English)
 */
$page_title = 'WestAce Withdrawals Australia - Payout Methods, Limits & Processing Times';
$page_description = 'Everything about ' . SITE_NAME . ' Casino withdrawals for Australian players: payout methods, processing times, daily and monthly limits, KYC verification, and tips for faster cashouts.';
...
<main>
    ...
    <div class="container">
      ...
      <div class="info-grid">
        <div class="info-card">
          ...
          <p>A$35 across all payment methods. Amounts below this threshold cannot be processed.</p>
        </div>
        <div class="info-card">
          <div class="info-card__icon">&#128200;</div>
          <h4>Processing Time</h4>
          <p>24-72 hours for most methods. Bank transfers may take 1-3 business days on top of that.</p>
        </div>
        <div class="info-card">
          <div class="info-card__icon">&#128197;</div>
          <h4>Withdrawal Limits</h4>
          <p>A$1,155 per day, A$3,715 per week, A$14,850 per month. VIP members qualify for higher limits.</p>
        </div>
      </div>

      <table class="quick-table" style="margin-top: var(--space-6);">
        <tr><th>Min Withdrawal</th><td>A$35</td></tr>
        <tr><th>Daily Limit</th><td>A$1,155</td></tr>
        <tr><th>Weekly Limit</th><td>A$3,715</td></tr>
        <tr><th>Monthly Limit</th><td>A$14,850</td></tr>
        <tr><th>VIP Daily</th><td>A$2,475</td></tr>
        <tr><th>VIP Weekly</th><td>A$11,550</td></tr>
        <tr><th>VIP Monthly</th><td>A$46,200</td></tr>
        <tr><th>Processing Time</th><td>24-72 hours</td></tr>
        <tr><th>Currency</th><td>AUD</td></tr>
        <tr><th>Fees</th><td>None (casino side)</td></tr>
      </table>
    </div>
  </section>
  ...
  <section class="content-section content-section--alt" id="methods">
    <div class="container">
      ...
      <div class="two-col" style="align-items:center;gap:var(--space-8);margin-bottom:var(--space-6)">
        <div>
          <p>The table below shows all deposit and withdrawal options at <?php echo SITE_NAME; ?>. We process payouts to the original deposit method when possible. All deposits and withdrawals are fee-free on our end. Transactions are processed in AUD with no currency conversion required.</p>
        </div>
        <div style="text-align:center;flex-shrink:0">
          <img src="/assets/img/westace-payments-screen.png" alt="<?php echo SITE_NAME; ?> Casino deposit and withdrawal methods including Mastercard, Skrill and crypto" style="max-width:280px;width:100%;border-radius:24px;box-shadow:0 8px 32px rgba(0,0,0,.3)">
        </div>
      </div>
      ...
      <p style="margin-top: var(--space-4);">The exact range of payment methods may vary depending on your region. Cryptocurrency transactions require blockchain confirmations after casino processing. All amounts are in AUD.</p>
    </div>
  </section>
  ...
  <section class="content-section content-section--alt" id="how-to">
    <div class="container">
      ...
      <ol class="steps-list">
        ...
        <li>
          <div>
            <strong>Select your payment method and amount.</strong> Choose from the available options and enter the amount you wish to withdraw. The minimum is A$35 across all methods. Daily limit is A$1,155, weekly limit is A$3,715, and monthly limit is A$14,850.
          </div>
        </li>
        <li>
          <div>
            <strong>Wait for processing.</strong> <?php echo SITE_NAME; ?> processes withdrawals within 24 to 72 hours. Bank transfers may take an additional 1-3 business days on the bank's end. You will be contacted if additional documents are needed for verification.
          </div>
        </li>
      </ol>
    </div>
    ...
    <div class="container">
      ...
      <div class="two-col">
        <div>
          ...
          <ul>
            <li><strong>Proof of ID</strong> - a passport, Australian driver's licence, or government-issued ID</li>
        ...
        <div>
          ...
          <ul>
            ...
            <li>Use a recent utility bill or bank statement dated within the last 3 months for proof of address</li>
  ...
  <section class="content-section content-section--alt" id="tips">
    <div class="container container--narrow">
      ...
      <p>Do not wait until your first withdrawal to submit your documents. Upload your ID, selfie, proof of address, and source of funds as soon as you register. When you are ready to cash out, there will be no delays from pending verification.</p>
      ...
      <h3>5. Withdraw in AUD</h3>
      <p>All accounts and transactions at <?php echo SITE_NAME; ?> are processed in AUD. There are no currency conversion delays or fees for Australian players.</p>
    </div>
  </section>
    ...
    <div class="container container--narrow">
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Most withdrawals are processed within 24 to 72 hours. E-wallets and cryptocurrency tend to arrive fastest. Bank transfers may take an additional 1-3 business days on the bank's end.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>The minimum withdrawal amount is A$35 for all payment methods.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Standard limits are A$1,155 per day, A$3,715 per week, and A$14,850 per month. Per-transaction limits depend on the method: Visa and Mastercard cap at A$4,200 per transaction, while Skrill, bank transfers, and all cryptocurrencies allow up to A$7,000. VIP players qualify for higher limits up to A$2,475/day, A$11,550/week, and A$46,200/month.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        <summary>Does <?php echo SITE_NAME; ?> process withdrawals in AUD?</summary>
        <div class="faq-answer">
          <p>Yes. All transactions at <?php echo SITE_NAME; ?> are processed in Australian Dollars (AUD). There is no currency conversion required for Australian players, and no conversion fees.</p>
        </div>
      </details>

      <details class="faq-item">
        <summary>How do I speed up my withdrawal?</summary>
        <div class="faq-answer">
          <p>The fastest options are Skrill and cryptocurrency. Verify your account before your first withdrawal to avoid KYC delays. Make sure the 1x deposit rollover is met. Use the same method you deposited with to avoid extra checks. For more tips, see the section above.</p>
        </div>
      </details>
    </div>
  </section>
