...
$page_description = 'Wszystkie bonusy ' . SITE_NAME . ' Casino w jednym miejscu. Bonus powitalny do 2 000 PLN + 200 darmowych spinów, kody promocyjne bez depozytu, cotygodniowe oferty doładowania, cashback i nagrody VIP.';
...
<main>
    ...
    <div class="container">
      ...
      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">100% do 2 000 PLN + 200 Darmowych Spinów</div>
          <span class="bonus-card__tag">Casino</span>
        </div>
        <p>Wpłać minimum 80 PLN, aby otrzymać pełne 100% dopasowania do pierwszej wpłaty, z limitem 2 000 PLN. Dodatkowo 200 darmowych spinów jest rozdzielanych w paczkach po 20 dziennie przez 10 kolejnych dni. Pierwsza paczka jest dostępna od razu po wpłacie. Musisz odebrać każdą porcję w ciągu 24 godzin, w przeciwnym razie wygasa. Wpłata co najmniej 40 PLN daje Ci również 1 kredyt Bonus Crab na próbę w automacie Claw Machine, gdzie nagrody obejmują monety, darmowe spiny, bonusy lub nagrody pieniężne.</p>
        <div class="bonus-card__details">
          <div>
            <div class="bonus-detail__label">Min. Wpłata</div>
            <div class="bonus-detail__value">80 PLN</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div class="bonus-detail__value">20 PLN</div>
          </div>
        </div>
      </div>
      ...
      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">250% do 12 000 PLN + 350 Darmowych Spinów</div>
          <span class="bonus-card__tag">Pakiet 4 Wpłat</span>
        </div>
        <p>Wielowpłatowy pakiet powitalny rozłożony na Twoje cztery pierwsze wpłaty. Pierwsza wpłata daje 100% do 4 000 PLN plus 200 darmowych spinów. Druga to 75% dopasowania do 2 000 PLN. Trzecia dodaje 50% do 2 000 PLN plus 50 darmowych spinów, a czwarta zamyka pakiet z 25% do 4 000 PLN plus 100 darmowych spinów.</p>
        <div class="bonus-card__details">
          <div>
            <div class="bonus-detail__label">Min. Wpłata</div>
            <div class="bonus-detail__value">80 PLN za wpłatę</div>
          </div>
          <div>
            <div class="bonus-detail__label">Obrót</div>
      ...
      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">100% Bonus Sportowy do 400 PLN</div>
          <span class="bonus-card__tag">Sport</span>
        </div>
        <p>Gracze obstawiający sport mogą odebrać 100% dopasowania do pierwszej wpłaty. Maksymalna kwota bonusu różni się w zależności od regionu: gracze z Finlandii, Niemiec, Norwegii, Szwajcarii i Austrii mogą otrzymać do 800 PLN. Gracze z Włoch otrzymują do 600 PLN. Gracze z Kazachstanu, Uzbekistanu, Kirgistanu, Tadżykistanu, Gruzji i Azerbejdżanu mogą otrzymać do 200 PLN. Aby aktywować bonus, pełna kwota wpłaty musi zostać obrócona na zakładach sportowych z kursem co najmniej 1.50.</p>
        <div class="bonus-card__details">
          <div>
            <div class="bonus-detail__label">Min. Wpłata</div>
            <div class="bonus-detail__value">80 PLN</div>
  ...
  <section class="content-section content-section--alt" id="reload">
    <div class="container">
      ...
      <div class="bonus-card">
        ...
        <p>Dokonaj wpłaty 80 PLN lub więcej od poniedziałku do czwartku, aby otrzymać 66 darmowych spinów na wybranym slocie. Musisz wyrazić zgodę (opt-in) co tydzień przed wpłatą. Spiny należy wykorzystać w ciągu 7 dni, a wygrane podlegają 40-krotnemu obrotowi z 10-dniowym terminem realizacji. Maks. zakład podczas aktywnego bonusu: 20 PLN.</p>
      </div>

      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">Weekendowe Doładowanie: 50% do 3 333 PLN + 77 Darmowych Spinów</div>
          <span class="bonus-card__tag">Piątek - Niedziela</span>
        </div>
        <p>Wpłać co najmniej 80 PLN w weekend, aby otrzymać 50% dopasowania do 3 333 PLN. Jeśli Twoja wpłata wynosi 200 PLN lub więcej, otrzymujesz także 77 darmowych spinów na wybranym slocie. Wymagana jest zgoda (opt-in) przed wpłatą. Obrót wynosi 35x od wpłaty plus bonusu i 40x od wygranych z darmowych spinów. Masz 10 dni na spełnienie warunków.</p>
      </div>

      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">Cotygodniowe Doładowanie Sportowe: 55% do 3 000 PLN</div>
          <span class="bonus-card__tag">Sport</span>
        </div>
        <p>Raz w tygodniu Twoja największa wpłata kwalifikuje się do 55% bonusu sportowego do 3 000 PLN. Wpłata musi zostać obrócona jednokrotnie na zakładach sportowych z kursem 1.50 lub wyższym, zanim bonus zostanie przyznany. Następnie możesz go odebrać przez czat na żywo lub email. Wymogi obrotu muszą zostać spełnione w ciągu 30 dni, a maksymalna wypłata z tego bonusu to 10-krotność jego wartości.</p>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="info-grid">
        <div class="info-card">
          ...
          <p>Dostępny od poziomu VIP 2 wzwyż. VIP 2 otrzymuje 3% do 400 PLN dziennie. VIP 3 otrzymuje 5% do 800 PLN. VIP 4 otrzymuje 10% do 1 200 PLN. VIP 5 otrzymuje 15% do 1 700 PLN. Cashback jest przyznawany automatycznie o 04:00 UTC i wymaga 1-krotnego obrotu. Musisz wyrazić zgodę co 4 tygodnie.</p>
        </div>
        <div class="info-card">
          <h4>Cashback Kasyno na Żywo: 25% do 1 500 PLN</h4>
          <p>Tygodniowy cashback od strat netto w grach kasyna na żywo. Minimalna kwalifikująca strata to 20 PLN. Skontaktuj się z obsługą klienta w poniedziałek po 06:00 UTC (przed 23:59 UTC), aby odebrać. Po przyznaniu cashback wymaga 1-krotnego obrotu przed wypłatą.</p>
        </div>
        <div class="info-card">
          <h4>Cashback Sportowy: 10% do 2 000 PLN</h4>
          <p>Obejmuje straty netto z zakładów sportowych od poniedziałku do niedzieli. Minimalna strata 80 PLN, aby się kwalifikować. Skontaktuj się z obsługą w poniedziałek, aby odebrać. Cashback podlega 3-krotnemu obrotowi i może być wykorzystany tylko w sekcji Sport.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="content-section content-section--alt" id="sports-promos">
    <div class="container">
      ...
      <div class="bonus-card">
        <div class="bonus-card__header">
          <div class="bonus-card__title">Bet Builder: 50% Bez Ryzyka do 200 PLN</div>
        </div>
        <p>Postaw Bet Builder z kursem 1.70 lub wyższym, używając co najmniej 80 PLN prawdziwych pieniędzy. Jeśli przegrasz, otrzymasz darmowy zakład o wartości 50% Twojej stawki (do 200 PLN). Dostępne raz w tygodniu. Darmowy zakład musi zostać wykorzystany w ciągu 3 dni i podlega 3-krotnemu obrotowi z kursem 1.50+.</p>
      </div>
    ...
    <div class="container">
      ...
      <div class="two-col">
        <div>
          ...
          <h3>Bonus Crab</h3>
          <p>Każda wpłata 80 PLN lub więcej daje Ci 1 kredyt Bonus Crab. Użyj go, aby „złapać" losową nagrodę z automatu Claw Machine -- możliwe nagrody to pieniądze bonusowe, darmowe spiny lub monety. To mały codzienny bonus, który urozmaica Twoje sesje.</p>
        </div>
        <div>
          <h3>Ekskluzywny Sklep</h3>
          <p>Monety zdobyte przez grę, wyzwania i promocje można wydać w sklepie. Nagrody obejmują darmowe spiny na wybranych slotach (np. 5 spinów na Sweet Bonanza za 30 monet) oraz pieniądze bonusowe (20 PLN za 50 monet, do 1 000 PLN za 1 200 monet). To miły sposób na zamianę lojalności w wymierne nagrody we własnym tempie.</p>

          <h3>Wyzwania</h3>
          <p>Cotygodniowe wyzwania nagradzają Cię za realizację prostych celów. Wyzwania kasynowe mogą wymagać postawienia zakładów 1,30 PLN na określonych slotach, a wyzwania sportowe -- zakładów 60 PLN na mecze z minimalnym kursem 2.0. Za każde ukończone wyzwanie zdobywasz monety, a ukończenie 20 w ciągu tygodnia daje bonus 50 monet.</p>
        </div>
      </div>
    </div>
  </section>
